<div x-data="{ open: false }" @open-edit-drawer-task.window="open = true" @task-updated.window="open = false" class="px-6 pt-4">
        ...
        <div class="w-screen max-w-md">
            <div class="h-full flex flex-col bg-white shadow-xl overflow-y-auto">
                <div class="py-6 px-4 bg-blue-600 flex justify-between items-center">
                    <h2 class="text-lg font-medium text-white">Edit Task</h2>
